...
PORT_PRIORITY: dict[PortType, int] = {
    PortType.EXEC: 100,
    PortType.CONDITION: 80,
    getattr(PortType, "DATA", PortType.STRING): 60,
    PortType.STRING: 50,
    getattr(PortType, "INT", PortType.STRING): 45,
    getattr(PortType, "FLOAT", PortType.STRING): 45,
}
BASE_X_SPACING = 260
BASE_Y_SPACING = 140
